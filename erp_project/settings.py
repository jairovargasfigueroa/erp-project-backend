...
SECRET_KEY = 'django-insecure-h3i^1@c%n**b5wp0rs_&h!2s3rk_#s%!@e5qb@0soe@b)da3m+'
...
#         'NAME': 'postgres',  # O el nombre que le hayas dado tú si creaste otra base
#         'USER': 'erp_postgres',
#         'PASSWORD': 'Abc123**',
#         'HOST': 'erp-db.postgres.database.azure.com',
#         'PORT': '5432',
#         'OPTIONS': {
#             'sslmode': 'require',
#         }
